...
const minting = require('../config/minting.json');

const basePath = config.basePath; // polygon or rinkeby
const AUTH = config.API_KEY;
const CONTRACT_ADDRESS = minting.wallet_adress;
const MINT_TO_ADDRESS = minting.wallet_adress; // YOUR WALLET ADDRESS HERE
const CHAIN = minting.chain;
const TIMEOUT = config.TIMEOUT; // Milliseconds. This a timeout for errors only. If there is an error, it will wait then try again. 5000 = 5 seconds.
